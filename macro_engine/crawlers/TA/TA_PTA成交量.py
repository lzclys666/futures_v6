...
"""
TA_PTA成交量.py
因子: TA_VOLUME = PTA期货主力合约成交量（手）

公式: 数据采集（无独立计算公式）

当前状态: [✅正常]
- L1: AKShare futures_main_sina("TA0") — 主力合约日行情
- L2: AKShare futures_zh_daily_sina("TA0") — 日行情成交量
- L3: 新浪实时API — 实时成交量

...
"""
PB_沪铅期货收盘价.py
因子: PB_FUT_CLOSE = 沪铅期货主力合约收盘价
当前状态: [✅正常]
- L1: AKShare futures_main_sina(symbol="PB0")
...
def main():
    ...
    if not (BOUNDS[0] <= raw_value <= BOUNDS[1]):
        ...
        return
    save_to_db(FCODE, SYM, pub_date, obs_date, raw_value, source_confidence=1.0, source='AKShare_Sina_PB0')

...
- bounds: [50000, 500000]手（豆一期货持仓量区间）
...
def fetch_l2():
    ...
    # 期货持仓量在 oi 列
    if "oi" not in latest.index.str.lower() and "持仓" not in latest.index.str.lower():

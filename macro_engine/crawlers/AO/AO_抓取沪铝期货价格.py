...
FACTOR_CODE = "AO_PRC_AL_FUT"
SYMBOL = "AO"
BOUNDS = (15_000, 30_000)
...
def fetch():
    ...
    print("[L2] 新浪 nf_AL0...")
    try:
        html, err = fetch_url("http://hq.sinajs.cn/list=nf_AL0", timeout=10)
...
def main():
    ...
    if save_l4_fallback(FACTOR_CODE, SYMBOL, pub_date, obs_date, extra_msg="(沪铝价格)"):
        pass
    else:

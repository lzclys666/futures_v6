...
"""
P_原油参考.py
因子: P_OIL_REF = INE原油期货主力合约收盘价

公式: P_OIL_REF = SC0主力合约日收盘价（元/桶）

当前状态: [✅正常]
- L1: AKShare futures_main_sina(symbol="SC0") — 新浪INE原油期货
- L2: 无备源
- L3: 无备源
...
def fetch():
    ...
    if df.empty:
        raise ValueError("AKShare无SC0数据")

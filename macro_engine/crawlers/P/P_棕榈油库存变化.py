...
"""
P_棕榈油库存变化.py
因子: P_INV_EM = 棕榈油库存变化量（东方财富）

公式: P_INV_EM = 当日库存 - 前日库存（吨）

当前状态: ✅正常
- L1: AKShare futures_inventory_em(symbol='棕榈') — 东方财富棕榈油库存
...
FCODE = "P_INV_EM"
SYM = "P"
BOUNDS = (-10000, 10000)  # 库存变化合理范围（吨）


def fetch():
    """L1: futures_inventory_em 棕榈油库存变化"""
    df = ak.futures_inventory_em(symbol="棕榈")

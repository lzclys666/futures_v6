...
FACTOR_CODE = "J_J_STK_COKE_RATE"
SYMBOL = "J"

def fetch_coke_rate():
    print("[NOTE] Coke plant utilization has no free data source, needs Mysteel/Fenwei paid account")
...
if __name__ == "__main__":
    ...
    value, source, confidence = fetch_coke_rate()

...
"""
HC_热卷库存变化.py
因子: HC_INV_EM = 热卷库存变化量（东方财富）

公式: HC_INV_EM = 当日库存 - 前日库存（吨）

当前状态: ✅正常
- L1: AKShare futures_inventory_em(symbol='热卷') — 东方财富热卷库存
...
FCODE = "HC_INV_EM"
SYM = "HC"
BOUNDS = (-50000, 50000)  # 库存变化合理范围（吨）


def fetch():
    """L1: futures_inventory_em 热卷库存变化"""
    df = ak.futures_inventory_em(symbol="热卷")

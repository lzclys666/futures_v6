...
"""
EG_抓取_期货最高价.py
因子: EG_FUT_HIGH = 乙二醇期货最高价

公式: 数据采集（主力合约最高价）

当前状态: [✅正常]
- L1: AKShare futures_main_sina(symbol='EG0') 最高价列
...
def run():
    ...
    # L4
    save_l4_fallback(FACTOR_CODE, SYMBOL, pub_date, obs_date, extra_msg="乙二醇最高价")

...
"""
EG_抓取_期货持仓量.py
因子: EG_FUT_OI = 乙二醇期货持仓量

公式: 数据采集（主力合约持仓量）

当前状态: [✅正常]
- L1: AKShare futures_main_sina(symbol='EG0') 持仓量列
...
def run():
    ...
    # L4
    save_l4_fallback(FACTOR_CODE, SYMBOL, pub_date, obs_date, extra_msg="乙二醇持仓量")
